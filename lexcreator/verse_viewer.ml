...
let create project = 
  ...
  let move_to_post_vis_button2 = GButton.button ~label:"Vis --> Post" ~packing:(hbox2#pack ~expand:false) () in
  let move_to_post_vis_button3 = GButton.button ~label:"Vis ---> Post" ~packing:(hbox2#pack ~expand:false) () in
  ...
  let move_from_post_vis_button2 = GButton.button ~label:"Vis <-- Post" ~packing:(hbox2#pack ~expand:false) () in
  let move_from_post_vis_button3 = GButton.button ~label:"Vis <--- Post" ~packing:(hbox2#pack ~expand:false) () in
  ...
  ignore (move_to_post_vis_all_button2#connect#clicked ~callback: (fun () ->
    move_lines_selection verse_viewer Verse.move_term_to_post_vis_allx));
  ignore (move_to_post_vis_all_button3#connect#clicked ~callback: (fun () ->
    move_lines_selection verse_viewer Verse.move_term_to_post_vis_allx));
